...
<body class="flex bg-[#F5F7FA]">
    ...
    <aside class="sidebar-navy w-64 min-h-screen text-white flex flex-col fixed z-50 shadow-2xl">
        <div class="py-10 flex justify-center items-center">
            <img src="{{ asset('assets/logo_dishub.png') }}" class="w-28 h-28 object-contain drop-shadow-xl"
                alt="Logo Dishub">
        </div>
    ...
    <main class="main-content ml-64 p-8 w-full">
        <header class="flex justify-between items-center mb-8">
            ...
            <div class="flex items-center gap-6">
                <div
                    class="flex items-center gap-2 text-orange-600 font-bold text-sm bg-orange-50 px-5 py-2 rounded-full border border-orange-100 shadow-sm">
        ...
        <div
            class="card-revenue p-10 flex items-center gap-8 mb-10 relative overflow-hidden bg-white rounded-[30px] shadow-[0_10px_25px_rgba(0,0,0,0.1)]">
            ...
            <div class="relative z-10">
                ...
                <p class="text-[12px] text-gray-500 font-bold uppercase tracking-wider mt-2">Total Pendapatan Harian (
                    Today )</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            <div class="relative overflow-hidden p-6 rounded-[25px] flex items-center gap-4 border border-blue-100 transition-transform hover:scale-105 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)]"
                ...
                <div
                    class="relative z-10 w-14 h-14 bg-[#4A78D7] rounded-2xl flex items-center justify-center shadow-md flex-shrink-0">
            ...
            <div class="relative overflow-hidden p-6 rounded-[25px] flex items-center gap-4 border border-orange-100 transition-transform hover:scale-105 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)]"
                ...
                <div
                    class="relative z-10 w-14 h-14 bg-[#E9A426] rounded-2xl flex items-center justify-center shadow-lg shadow-orange-600/30 flex-shrink-0">
            ...
            <div class="relative overflow-hidden p-6 rounded-[25px] flex items-center gap-4 border border-purple-100 transition-transform hover:scale-105 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)]"
                ...
                <div
                    class="relative z-10 w-14 h-14 bg-[#953EE1] rounded-2xl flex items-center justify-center shadow-lg shadow-purple-600/30 flex-shrink-0">
            ...
            <div class="relative overflow-hidden p-6 rounded-[25px] flex items-center gap-4 border border-pink-100 transition-transform hover:scale-105 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)]"
                ...
                <div
                    class="relative z-10 w-14 h-14 bg-[#E95BA4] rounded-2xl flex items-center justify-center shadow-lg shadow-pink-600/30 flex-shrink-0">
                ...
                <table class="w-full border-separate border-spacing-y-3">
                    <thead>
                        <tr class="bg-gray-200">
                            <th
                                class="p-4 text-gray-800 font-bold text-center rounded-l-xl border-y border-l border-black">
                                Objek</th>
                            ...
                            <th
                                class="p-4 text-gray-800 font-bold text-center rounded-r-xl border-y border-r border-black">
                    ...
                    <tbody>
                        <tr class="bg-white group transition-all">
                            <td
                                class="p-4 text-center font-bold text-gray-800 border-y border-l border-black rounded-l-2xl">
                                Mini Bus</td>
                            <td class="p-4 text-center font-bold text-gray-800 border-y border-black">Pelabuhan Kusamba
                            </td>
                            <td class="p-4 text-center font-bold text-gray-800 border-y border-black">20</td>
                            <td
                                class="p-4 text-center font-bold text-gray-800 border-y border-r border-black rounded-r-2xl">
                                Rp. 1000.000</td>
                        </tr>
                        <tr class="bg-white">
                            <td
                                class="p-4 text-center font-bold text-gray-800 border-y border-l border-black rounded-l-2xl">
                                Truk</td>
                            <td class="p-4 text-center font-bold text-gray-800 border-y border-black">Terminal Galiran
                            </td>
